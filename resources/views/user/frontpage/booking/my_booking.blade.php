  ...
  <section class="max-w-6xl mx-auto px-6 py-10 relative mt-20">
      ...
      <div class="mb-6">
          ...
          <p class="text-black pt-3 text-sm">Manage your active and upcoming banner advertising campaigns</p>
      </div>
      ...
      <section class="mx-auto max-w-7xl my-10">
          <div class="grid grid-cols-12 gap-7">
              <div class="col-span-12 md:col-span-6 lg:col-span-6 bg-white rounded-2xl py-7 px-8 shadow-xl">
                  ...
                  <p class="mt-3 text-lg font-semibold text-black">Timeline</p>

                  <div class="text-xs text-[#747474] mt-1">
                      📅 start : 2025-05-15 &nbsp; End : 2025-08-15
                  </div>

                  <p class="text-xs text-[#1C5AE9] font-medium mt-2">495 days remaining</p>

                  <span class="mt-3 inline-block bg-[#21C45D] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Active
                  </span>
      ...
      <!-- add card-->
      <section class="mx-auto max-w-7xl my-7">
          <div class="grid grid-cols-12 gap-7">
              <div class="col-span-12 md:col-span-6 lg:col-span-6 bg-white rounded-2xl py-7 px-8 shadow-xl">
                  <div class="flex justify-between items-center">
                      <h2 class="font-semibold text-[#234693] text-lg">Gandhipuram Signal</h2>
                      <span class="text-[#3C83F6] text-lg font-medium">Investment</span>
                  </div>
                  <div class="flex ">
                      <p class="text-sm text-[#747474] mt-1">📍 Ukkadam, Coimbatore</p>
                  ...
                  <span class="mt-3 inline-block bg-[#3C83F6] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Upcoming
                  </span>
