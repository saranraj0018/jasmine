  ...
  <section class="max-w-6xl mx-auto px-6 py-10 relative mt-20">
      <!-- Section Header -->
      <div class="mb-6">
          <h2 class="md:text-2xl text-xl font-bold text-[#234693]">Campaign History</h2>
          <p class="text-black pt-3 text-sm">Your Completed advertising campaigns and total investment</p>
      </div>
      ...
      <section class="space-y-6 max-w-6xl my-10 mx-auto">
          <!-- CARD -->
