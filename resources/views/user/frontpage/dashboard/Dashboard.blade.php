    ...
    <section class="mt-40 mx-auto max-w-6xl">
        <h1 class="text-2xl font-medium text-[#264795]">Welcome Back, Acme Corp !</h1>
    ...
    <!-- Recent Bookings -->
    <section class="mx-auto max-w-6xl mt-5 mb-20">
        ...
        <div class="bg-[#F4F4F4] rounded-xl shadow-2xs py-3 px-5">
            ...
            <div class="flex justify-between ">
                ...
                <p class="text-sm text-white rounded-3xl mt-3 bg-[#1C356E] py-1 px-5 font-medium">Active</p>
            </div>
